...
const Table = ({
  ...
  // Function to render status badge with icon and text
  ...
  // Handle click on "See All" button
  ...
  return (
    <div className={`overflow-x-auto ${width}`} dir="rtl">
      {/* Table Header */}
