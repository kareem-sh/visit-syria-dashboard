...
const StatCard = ({
    ...
    return (
        ...
        flex-grow min-w-[280px] h-[200px] max-w-sm sm:max-w-md md:max-w-lg shadow-lg
      `}
        >
            {/* Background Icon */}
            <img
        ...
        `}
            ...
            <div className="flex items-center justify-between">
                <span className="text-body-regular-16">{title}</span>
                <div className="bg-black/10 p-2 rounded-[10px]">
            ...
            <div className="flex justify-start items-center gap-1 mt-auto">
                <img src={trendIcon} alt="trend icon" className="w-4 h-4" />
                <span className={`text-body-regular-16 ${trendValueClass}`}>{trend}</span>
                <span>{subtitle}</span>
            </div>
        </div>
    );
